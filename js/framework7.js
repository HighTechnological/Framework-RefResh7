/**
<<<<<<< HEAD:js/framework7.js
 * Framework7 1.6.0
=======
 * Framework7 1.6.4
>>>>>>> nolimits4web/master:dist/js/framework7.js
...
>>>>>>> nolimits4web/master:dist/js/framework7.js
        ...
        app.params = {
            ...
            modalUsernamePlaceholder: 'Имя пользователя',
            modalPasswordPlaceholder: 'Пароль',
            modalTitle: 'Citrus OS',
...
>>>>>>> nolimits4web/master:dist/js/framework7.js
            ...
            notificationCloseButtonText: 'Закрыть',
            // Animate Pages
            animatePages: true,
            // Template7
            templates: {},
              ...
              //Иконки в модальном окне
                ...
                if (params.buttons && params.buttons.length > 0) {
                    for (var i = 0; i < params.buttons.length; i++) {
                      buttonsHTML += '<span class="modal-button' + (params.buttons[i].bold ? ' modal-button-bold' : '') + '"><i class="icon icon-' + params.buttons[i].text + '"></i></span>';
                    }
                }
        ...
        ************   Calendar   ************
        ...
        var Calendar = function (params) {
            ...
            var defaults = {
                ...
                monthNamesShort: ['Янв', 'Феф', 'Март', 'Апр', 'Май', 'Июнь', 'Июль', 'Авг', 'Сен', 'Окт', 'Нояб', 'Дек'],
            ...
            p.monthHTML = function (date, offset) {
                ...
                for (i = 1; i <= rows; i++) {
                    ...
                    for (j = 1; j <= cols; j++) {
                        ...
                        rowHTML += '<div  event="'+ eventDate +'" data-year="' + dayYear + '" data-month="' + dayMonth + '" data-day="' + dayNumber + '" class="picker-calendar-day' + (addClass) + '" data-date="' + (dayYear + '-' + dayMonth + '-' + dayNumber) + '"><span>'+dayNumber+'</span></div>';
                    }
